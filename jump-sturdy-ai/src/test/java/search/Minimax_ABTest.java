...
public class Minimax_ABTest {
    ...
    public void testGruppeAG() {
        testMoves("6/8/8/8/b0b02b0b02/2b05/2r0r0r0r02/6 b", "C6-D7");
        testMoves("3b01b0/3bb1b02/8/8/8/2r0b0r03/8/0r04r0 b", "D6-D7");
    }
    ...
    public void testGruppeS() {
        ...
        testMoves("2b03/1b0b05/6b01/3b02r01/1b01r02r01/2b05/2r03r01/3r02 b", "B5-C5","B5-B6");
    }

    @Test
    @DisplayName("Gruppe Z")
    public void testGruppeZ() {
        testMoves("6/8/6r01/2b01r0r02/1r03r02/8/8/6 r", "B5-C4");
    ...
    public void testGruppeJ() {
        testMoves("6/1bb1b0bbb0b01/r02b04/2b01b0b02/2r02r02/1r02rrr02/6rr1/2r01r01 r", "A3-B2");
    ...
    public void testGruppeI() {
        testMoves("3b02/5b02/8/1b06/4bb3/6r01/1r06/1r0r03 b", "E5-F7");
    ...
    public void testGruppeW() {
        testMoves("6/8/2b01b03/6b0r0/4b03/8/r07/6 b", "E5-E6");
        testMoves("6/8/8/8/8/1r0b0r0b0r02/4r03/3rr2 r", "E8-C7");
    }

    @Test
    @DisplayName("Gruppe R")
    public void testGruppeR() {
        testMoves("2b03/r07/3r04/6rr1/4bb3/2b04bb/3rr1rr2/5r0 b", "H6-G8");
    ...
    public void testGruppeAC() {
        testMoves("3b01b0/3b04/3bb4/2r05/rbbr5rb/4rr3/br4r02/6 b", "A5-B7","H5-G7");
    ...
    public void testGruppeK() {
         testMoves("1bbb01b0b0/4b03/4r01b01/2b01r0b02/5r02/1r06/3r02r01/1rrr01r01 r", "E4-E3");
         testMoves("b0b02b01/3b01b0b01/2r01r02b0/4r0b02/r07/3b04/5r02/rr3rr1 r", "E3-D2","C3-D2");
    }

    @Test
    @DisplayName("Gruppe AF")
    public void testGruppeAF() {
        testMoves("1b0b0b0b0b0/1b06/8/2bb5/8/3rr4/1r03r0r01/r0r0r0r0r0r0 b", "C4-D6");
    ...
    public void testGruppeG() {
        testMoves("b02b01b0/4r03/1b02r03/1bb6/8/4r0b02/1r03r02/r01r02r0 r", "E3-E2");
    ...
    public void testGruppeV() {
        testMoves("1b01b02/8/3b04/1rbr05/6bb1/1r02r03/2rr5/6 b", "G5-F7");
    ...
    public void testGruppeO() {
        testMoves("6/8/5bb2/8/6b01/8/r07/6 b", "F3-G5","G5-G6");
        testMoves("6/4r03/8/8/8/8/4b03/6 r", "E2-E1");
    }
