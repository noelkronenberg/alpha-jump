...
- ```game-server``` Jump Sturdy server for playing against other players (based on an [implementation](https://git.tu-berlin.de/lengfeld8/jump-sturdy-game-server) of the course organisors
